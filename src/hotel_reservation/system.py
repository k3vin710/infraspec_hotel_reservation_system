...
class HotelReservationSystem:
    ...
    def parse_input(self, input_str: str) -> Tuple[CustomerType, List[datetime]]:
        ...
        try:
            ...
            try:
                ...
                raise ValueError(f"Invalid customer type: {customer_str}. Must be 'Regular' or 'Rewards'")
            ...
            for date_str in date_strings:
                ...
                try:
                    ...
                    raise ValueError(f"Invalid date format: {date_str}. Expected format: DDMmmYYYY")
    ...
    def calculate_total_cost(self, hotel: Hotel, customer_type: CustomerType, dates: List[datetime]) -> int:
        """
